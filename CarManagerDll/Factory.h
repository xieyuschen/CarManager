...
extern "C" CsvReader_API CarManagerCommon::CsvReader * __cdecl CreateCsvReader1(string, char);
extern "C" CsvReader_API CarManagerCommon::CsvReader * __cdecl CreateCsvReader2(string);
