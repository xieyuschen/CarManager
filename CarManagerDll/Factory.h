...
//extern "C" CsvReader_API CarManagerCommon::CsvReader * __cdecl CreateCsvReader1(string);
//extern "C" CsvReader_API CarManagerCommon::CsvReader * __cdecl CreateCsvReader2();
//
